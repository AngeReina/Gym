...
public class InstructorService {
    ...
    public List<Instructor> buscarPorNombre(String nombre) {
        return instructorRepository.buscarPorNombre(nombre);
    }

    public List<Instructor> instructoresConClases() {
        return instructorRepository.instructoresConClases();
    }

    public List<Object[]> rankingSesiones() {
        return instructorRepository.sesionesPorInstructor();
    }
}